...
public class Formatter {
	...
	public static void print(java.io.PrintStream s, String fmt, double x) {
		s.print(new Formatter(fmt).form(x));
	}
	...
	public static void main(String[] a) {
		...
		double u = 1.234e-5;
		int d = 0xCAFE;
		Formatter.print(System.out, "x = |%f|\n", x);
		Formatter.print(System.out, "u = |%20f|\n", u);
		Formatter.print(System.out, "x = |% .5f|\n", x);
		Formatter.print(System.out, "w = |%20.5f|\n", w);
		Formatter.print(System.out, "x = |%020.5f|\n", x);
		Formatter.print(System.out, "x = |%+20.5f|\n", x);
		Formatter.print(System.out, "x = |%+020.5f|\n", x);
		Formatter.print(System.out, "x = |% 020.5f|\n", x);
		Formatter.print(System.out, "y = |%#+20.5f|\n", y);
		Formatter.print(System.out, "y = |%-+20.5f|\n", y);
		Formatter.print(System.out, "z = |%20.5f|\n", z);

		Formatter.print(System.out, "x = |%e|\n", x);
		Formatter.print(System.out, "u = |%20e|\n", u);
		Formatter.print(System.out, "x = |% .5e|\n", x);
		Formatter.print(System.out, "w = |%20.5e|\n", w);
		Formatter.print(System.out, "x = |%020.5e|\n", x);
		Formatter.print(System.out, "x = |%+20.5e|\n", x);
		Formatter.print(System.out, "x = |%+020.5e|\n", x);
		Formatter.print(System.out, "x = |% 020.5e|\n", x);
		Formatter.print(System.out, "y = |%#+20.5e|\n", y);
		Formatter.print(System.out, "y = |%-+20.5e|\n", y);

		Formatter.print(System.out, "x = |%g|\n", x);
		Formatter.print(System.out, "z = |%g|\n", z);
		Formatter.print(System.out, "w = |%g|\n", w);
		Formatter.print(System.out, "u = |%g|\n", u);
		Formatter.print(System.out, "y = |%.2g|\n", y);
		Formatter.print(System.out, "y = |%#.2g|\n", y);

		Formatter.print(System.out, "d = |%d|\n", d);
		Formatter.print(System.out, "d = |%20d|\n", d);
		Formatter.print(System.out, "d = |%020d|\n", d);
		Formatter.print(System.out, "d = |%+20d|\n", d);
		Formatter.print(System.out, "d = |% 020d|\n", d);
		Formatter.print(System.out, "d = |%-20d|\n", d);
		Formatter.print(System.out, "d = |%20.8d|\n", d);
		Formatter.print(System.out, "d = |%x|\n", d);
		Formatter.print(System.out, "d = |%20X|\n", d);
		Formatter.print(System.out, "d = |%#20x|\n", d);
		Formatter.print(System.out, "d = |%020X|\n", d);
		Formatter.print(System.out, "d = |%20.8x|\n", d);
		Formatter.print(System.out, "d = |%o|\n", d);
		Formatter.print(System.out, "d = |%020o|\n", d);
		Formatter.print(System.out, "d = |%#20o|\n", d);
		Formatter.print(System.out, "d = |%#020o|\n", d);
		Formatter.print(System.out, "d = |%20.12o|\n", d);

		Formatter.print(System.out, "s = |%-20s|\n", "Hello");
		Formatter.print(System.out, "s = |%20s|\n", "Hello");
		Formatter.print(System.out, "s = |%-20c|\n", '!');

		// regression test to confirm fix of reported bugs

		Formatter.print(System.out, "|%i|\n", Long.MIN_VALUE);

		Formatter.print(System.out, "|%6.2e|\n", 0.0);
		Formatter.print(System.out, "|%6.2g|\n", 0.0);

		Formatter.print(System.out, "|%6.2f|\n", 9.99);
		Formatter.print(System.out, "|%6.2f|\n", 9.999);

		Formatter.print(System.out, "|%6.0f|\n", 9.999);
	}
