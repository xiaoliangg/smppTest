...
import org.smpp.temp.Connection;
...
public class SMSCListenerImpl extends SmppObject implements Runnable, SMSCListener {
	...
	private int port;
	private long acceptTimeout = org.smpp.temp.Data.ACCEPT_TIMEOUT;
	...
	public static void main(String[] args) throws IOException {
		SMSCListenerImpl si = new SMSCListenerImpl(8801,true);
		si.listen();
	}
	...
	public synchronized void start() throws IOException {
		...
		if (!isReceiving) {
			serverConn = new org.smpp.temp.TCPIPConnection(port);
